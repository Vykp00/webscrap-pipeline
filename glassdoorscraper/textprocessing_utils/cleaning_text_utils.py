...
# Remove special character but retain special characters
# like "+", "#", and "."
def remove_special_characters(text, text_is_tech=True, remove_digits=False):
    # If the raw_text have tech skills keywords, retain special characters
    # like "+", "#", and "."
    if text_is_tech:
...
def normalize_corpus(corpus, contraction_expansion=True,
    ...
    if special_char_removal:
        ...
        corpus = remove_special_characters(corpus, text_is_tech=text_is_tech, remove_digits=remove_digits)
